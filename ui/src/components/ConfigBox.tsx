  ...
  return (
    <Card variant="outlined">
      <Box sx={styles}>
        <List>
          <ListItem>
            <ListItemText>Kubeconfig: {kubeconfig}</ListItemText>
          </ListItem>
          <ListItem>
            <ListItemText>Context: {context}</ListItemText>
          </ListItem>
          <ListItem>
            <ListItemText>Image: {image}</ListItemText>
          </ListItem>
          <ListItem>
            <ListItemText>Namespace: {namespace}</ListItemText>
          </ListItem>
        </List>
      </Box>
    </Card>
